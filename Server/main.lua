local function LoadESXVersion()
    ...
    RegisterNetEvent('ProjextX-OrangeFarm:GratherOrange', function()
        local src = source
    ...
    RegisterNetEvent('ProjextX-OrangeFarm:SellingRawOrange', function()
        local src = source
        local xPlayer = ESX.GetPlayerFromId(src)
        local price = 0
    ...
    RegisterNetEvent('ProjextX-OrangeFarm:SellingJuices', function()
        local src = source
        local xPlayer = ESX.GetPlayerFromId(src)
        local price = 0
